...
#		datafile.write ("%s %s %s %s %s %s %s %s %s %s\n" %(anno,mese,giorno,ora,v,vmax,t,d,u,p))
...
# E' possibile riconoscer se un nodo e' attivo o no.
# Nel caso sia ttivo questo vine campionato alla frequenza configurata
# Nela caso non sia attivo  veiene interrogato a frequenza dieci volte inferiore
# Quando un nodo non risponde  alla richeysa di tati viene messo in attesa
# e considerato non attivo.
#============================================================================
class NODO:
#============================================================================
# Inizializzazione Nodo:
# nodo_ref = Dizionario che descrive il nodo. Le chiavi sono i nomi delle colonne della tabella nodi DB
# trate    = Periodo di campionamanto in secondi per nodo attivo
# twait    = Periodo di campionamneto se il nodo non risulta attivo
#============================================================================
	def __init__(self,nodo_ref,trate,twait):
		self.me = nodo_ref
...
# i Tempi di attesa per ogni nodo sono calcolati random per avere una distribuzione
# casuale uniforme in funzione del numero dei nodi:
# SPERO !
#============================================================================
	def run(self):
...
# del luogo della antenna , se  dichiarati nella configurazione del servizio
# SNMP sulla antenna e calcola l'indice del device di comunicazione
#============================================================================
	def registra (self):
...
#============================================================================
	def get_location(self):
		...
		if (len(r)):
			...
			return ""
#============================================================================
# Ricerca l'indice di tabella della porta del nodo da monitorare (es: ath0 -> indice 5)
#============================================================================
...
#============================================================================
	def deactivate(self):
		...
		if (ninux_db.reopenDB("ninux_rate")):
			...
			ninux_db.closeDB()
#============================================================================
# Salva i dati acquisiti nel DB tabella dati
#============================================================================
...
# La password
#============================================================================
	def __init__ (self,host,user,passw, debug=0):
		self.host=host
		self.user=user
		self.passw=passw
		self.open=0
...
# Program Main 
#============================================================================
ninux_db = DB ('172.16.1.9','ninux','ninux') ## Istanzia il Data Base
